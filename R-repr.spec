...
Version  : 0.18
Release  : 31
URL      : https://cran.r-project.org/src/contrib/repr_0.18.tar.gz
Source0  : https://cran.r-project.org/src/contrib/repr_0.18.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1546461307
