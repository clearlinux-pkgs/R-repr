...
Version  : 0.19.1
Release  : 32
URL      : https://cran.r-project.org/src/contrib/repr_0.19.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/repr_0.19.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1546463926
